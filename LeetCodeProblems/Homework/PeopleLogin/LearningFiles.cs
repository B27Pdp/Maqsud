...
namespace LeetCodeProblems.Homework.PeopleLogin
{
    class LearningFiles
    {
        ...
        public void AddToListAllItems()
        {
            ...
            directoryInfo = new DirectoryInfo(directoryInfo?.FullName + @"\Person\PersonDate1.txt");
        ...
        public void CreateFile(int id, string name, string address)
        {
            ...
            DirectoryInfo? directoryInfo = new DirectoryInfo(path);
            directoryInfo = directoryInfo?.Parent?.Parent?.Parent;
            directoryInfo = new DirectoryInfo(directoryInfo?.FullName + @"\Person");
            if (!File.Exists(directoryInfo.FullName + @"\PersonDate1.txt"))
            {
                File.Create(directoryInfo.FullName + @"\PersonDate1.txt").Dispose();
            }
            string pathOfTextFile = directoryInfo.FullName + @"\PersonDate1.txt";
        ...
        public void DeleteUserById(int deleteID)
        {
            ...
            DirectoryInfo? directoryInfo = new DirectoryInfo(path);
            directoryInfo = directoryInfo?.Parent?.Parent?.Parent;
            directoryInfo = new DirectoryInfo(directoryInfo?.FullName + @"\Person\PersonData1.txt");
            string pathOfText = directoryInfo.FullName;
